-- Migration 018: Fix Reserve Spot Function with Waitlist
-- Restores correct waitlist behavior (limit 50) and ensures muslim confirmation is tracked
...
BEGIN
    ...
    IF v_confirmed_count < v_capacity_limit THEN
        ...
        -- Note: We include confirmed_muslim=true by default as per requirement for this flow
