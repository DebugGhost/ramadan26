-- Migration 012: Revert Demo Limits
-- Restores real capacity limits and waitlist size

-- 1. Restore capacity to 235 for all day
UPDATE public.days SET capacity_limit = 235;

-- 2. Restore reserve_spot function with larger waitlist (50)
...
DECLARE
    ...
    v_max_waitlist INTEGER := 50; -- Restored to 50
BEGIN
