-- Migration 008: Adjust limits for testing
-- Sets capacity to 2 and waitlist limit to 1

-- 1. Update capacity for all days
UPDATE public.days SET capacity_limit = 2;

-- 2. Update reserve_spot function to limit waitlist to 1
...
DECLARE
    ...
    v_max_waitlist INTEGER := 1; -- CHANGED FROM 10 TO 1 FOR TESTING
BEGIN
